...
Here's how our registration works. There are adult runners (over 18 years of age) and 
...
const registeredEarly = true; //Determine if runner registered early
const runnersAge = 20; //Determine the age of the runner
...
if (runnersAge > 18 && registeredEarly == true) {
    console.log(`You will start at 9:30AM Number ${raceNumber}`);
}
else if (runnersAge > 18 && registeredEarly == false) {
    console.log(`You will start at 11:00AM Number ${raceNumber}`);
